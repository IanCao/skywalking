...
public class HistoryDeleteDAO implements IHistoryDeleteDAO {
    ...
    public void deleteHistory(Model model, String timeBucketColumnName, int ttl) throws IOException {
        ...
        builder.append("delete from ").append(model.getName()).append(" where ").append(timeBucketColumnName).append("<= ?");
        ...
        //Delete Action
        cassandraClient.getCqlSession().execute(builder.toString(), deadline);
    }
}
